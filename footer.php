<!DOCTYPE html>
    ...
    <body>
        <div class="footer">
            ...
            <a class="Github" href="https://github.com/LuciferMonao/clicktest"><img src="src/img/github.png" alt="Github"></a>
            ...
            <p>&copy 2020, <a href= "../index.php">Lucifer Monao</a>, Some Rights Reserved</p>
        </div>
    </body>
</html>